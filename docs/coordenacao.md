...
## Estado atual — 2026-09-07 (sessão 10: FATIA 3e COMPLETA na branch `feat/datasets-export-import` — 10 commits, review APROVA COM NITS, verificação final 38/38; aguardando push/CI/merge do usuário)
