...
- Corrigir/Implementar:
  - Geração/Galeria (implementado/validar):
    - [ ] 001: A galeria da Geração se está nela e atualiza a pagina volta para a tela de Geração.
  ...
  - Action center:
    - [ ] 001: Botões estão diferente da arquitetura de DESIGN.md, a side bar do Action Center ficou com uma barra lateral que alguns itens "quebrados" o texto escapa do modal
          tem uma barra estranha e um efeito branco estranho quando clica para exibir mais detalhes
