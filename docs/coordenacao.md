...
## Estado atual — 2026-09-07 (sessão 11: emenda v2.1 COMPLETA — estilo Arcane autêntico; 14 commits na branch; push/CI/merge = usuário)
...
- **Nota**: a densidade 14px encolheu TODA a UI ~12,5% — se o usuário achar que algo ficou pequeno demais além dos botões, é reversível em 1 linha (globals.css). Arcane real :30258 continua de pé como referência viva; navegação de leitura apenas (nunca clicar ações nele).
