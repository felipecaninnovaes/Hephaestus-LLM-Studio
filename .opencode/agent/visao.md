---
description: Proxy de visão do coordenador — recebe imagens (screenshots anexados, PNGs de evidência, artes de referência) e devolve DESCRIÇÃO FÁTICA em texto denso. Não opina, não sugere, não edita, não roda Chrome. Usar quando o @hephaestus (modelo sem visão) precisar de contexto visual; para auditar/corrigir telas o agente certo é @ui-designer.
mode: subagent
