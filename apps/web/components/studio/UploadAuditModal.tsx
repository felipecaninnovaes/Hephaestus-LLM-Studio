            ...
            currentList.map((item, idx) => (
              ...
              >
                <div className="flex items-center space-x-2.5 min-w-0">
                  <span className="font-mono text-3xs text-zinc-500 w-5 text-right">
                    #{idx + 1}
                  </span>
                ...
                <div className="flex items-center space-x-2 shrink-0">
                  <button
                    ...
                    className="flex items-center space-x-1 rounded px-2 py-1 font-mono text-3xs text-zinc-400 hover:text-zinc-200 hover:bg-white/5 transition-colors cursor-pointer"
                  >
