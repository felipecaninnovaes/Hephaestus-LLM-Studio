...
name: docs-sync
description: >-
  Sincronizador de docs do Hephaestus — mantém docs/backend.md §9/§10, docs/frontend.md §10 e packages/contracts espelhando o código implementado. Edição mecânica guiada por código.
subagent: true
---
