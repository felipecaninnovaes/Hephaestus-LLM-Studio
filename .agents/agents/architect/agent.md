...
name: architect
description: >-
  Arquiteto de software do Hephaestus — projeta contratos de API, schema Postgres, fatias verticais e decisões de boundary entre serviços. Use antes de implementar mudanças estruturais.
subagent: true
---
