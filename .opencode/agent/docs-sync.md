...
1. Extraia o fato do CÓDIGO (rota anotada no handler, struct de request/response, migration), não da spec desejada — o código é a verdade depois de implementado.
...
4. Ao final, rode `graft build` se sugerido pelo coordenador (refresh do grafo).
