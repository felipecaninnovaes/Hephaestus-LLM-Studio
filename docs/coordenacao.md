...
- **Próximo passo na ordem**: F4.1 (em curso, `@rust-dev` na `feat/jobs-v1`: migration 0006 + refactor export.rs + `POST /:id/package` + spec 0.7.0 só-package) → F4.2 → F4.3 → F4.4 → F4.5 ∥ F4.6 → F4.7 → F4.8 → F4.9. DDL da 0006 = §"Migration 0006" da ADR-0007 (:499+).
